...
/********************************************************************************************************************
*   Get up to 1 message containing the searchToken from an the specified SQS Queue.  The message is deleted from the queue
*
...
echo GetSqsMessage($queueUrl, $waitTime, $searchToken);
